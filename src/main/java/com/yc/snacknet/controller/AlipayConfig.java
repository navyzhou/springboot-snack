...
public class AlipayConfig {
	...
	public static String notify_url = "http://127.0.0.1:8080/snack-ssm/order/alipay/notify_url";

	// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
	//public static String return_url = "http://127.0.0.1:8080/snacknet/return_url.jsp";
	public static String return_url = "http://127.0.0.1:8080/snack-ssm/order/alipay/return_url";
